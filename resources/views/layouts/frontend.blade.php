...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="frontend/assets/img/icon.jpg">
        @stack('style-alt')
        <title>BaliWonders</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <img src="../../frontend/assets/img/icon.jpg" alt="BaliWonders Logo" class="iconweb">
                    BaliWonders
                </a>
        ...
        <footer class="footer section">
            ...
            <div class="footer__info container">
                <span class="footer__copy">
                    &#169; BaliWonders. All rigths reserved
                </span>
